...
var _Control = require('simple-react-video/lib/Control');

var _Control2 = _interopRequireDefault(_Control);

var _PlayBtn = require('simple-react-video/lib/PlayBtn');

var _PlayBtn2 = _interopRequireDefault(_PlayBtn);

var _Loading = require('simple-react-video/lib/Loading');

var _Loading2 = _interopRequireDefault(_Loading);

require('simple-react-video/assets/style.css');
...
var ReactVideo = (_class = function (_Component) {
    ...
    _createClass(ReactVideo, [{
        ...
        value: function componentWillMount() {
            ...
            (0, _mobx.autorun)(function () {
                ...
                if (_this2.videoData.needCheck) {
                    _utils2.default.requestAF(_this2.checkHandle, _this2.props.flatID);
                } else {
                    _utils2.default.removeAf(_this2.props.flatID);
                }
        ...
        value: function onMouseEnter() {
            if (_utils2.default.platform.isDesktop) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'video-block ' + this.props.videoClass, ref: function ref(_ref2) {
                            _this4.videoBlock = _ref2;
                        }, onClick: _utils2.default.platform.isDesktop ? this.togglePlayPauseHandle : this.onMouseClickHandle },
                    this.props.posterSrc && _react2.default.createElement('img', { className: 'poster', src: this.props.posterSrc, onError: function onError() {
                            if (_this4.videoBlock) {
                                _this4.videoBlock.classList.add('poster-error');
                            }
                        } }),
                    _react2.default.createElement(_PlayBtn2.default, null),
                    _react2.default.createElement(_Loading2.default, null),
                    _react2.default.createElement(
                        'video',
                        { loop: true, playsInline: true, muted: true, preload: 'none', ref: function ref(_ref) {
                                _this4.initVideo(_ref);
                            }, id: this.props.flatID, onError: function onError() {
                                if (_this4.videoBlock) {
                                    _this4.videoBlock.classList.add('video-error');
                                }
                            } },
                        _react2.default.createElement('source', { src: this.props.videoSrc, type: 'video/' + this.props.videoExt })
                    )
                ),
                _react2.default.createElement(_Control2.default, _extends({}, this.props, { videoData: this.videoData, seekVideo: this._seek.bind(this), videoObj: this, ref: function ref(_ref3) {
                        _this4.ctr = _ref3;
                    } }))
            );
        }
    ...
    return ReactVideo;
}(_react.Component), (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'videoData', [_mobx.observable], {
    enumerable: true,
